...
class LinearNEInstance:public BaseInstance<LinearNEInstance, Sentence, ComType::Label_Str_Vector>{
public:
    LinearNEInstance();
    LinearNEInstance(int instance_id, double weight, Sentence *ptr_sent, ComType::Label_Str_Vector *ptr_labels);
    ~LinearNEInstance();
    int GetSize();
